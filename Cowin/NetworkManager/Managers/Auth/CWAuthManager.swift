...
extension CWNetworkManager {
    ...
    internal func triggerGenerateOTP(mobile number: String , onCompletion result:((CWOTPRequestModel? , String?) -> ())? = nil) {
    ...
    internal func triggerValidateOTP(txnID: String , otpValue: String , onCompletion result:((CWOTPValidateModel? , String?) -> ())? = nil) {
